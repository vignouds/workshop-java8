...
public class Function_01_Test {
    ...
    private Function<Integer, Person> intToPerson = entier->{
    	...
    	personne.setLastname("last_"+entier);
    	personne.setAge(entier);
    	personne.setPassword("pass_"+entier);
    	return personne;
    };
    // end::intToPerson[]
    ...
    private Function<Person, Account> personToAccount = personne->{
    	Account compte = new Account();
    	compte.setOwner(personne);
    ...
    private Function<Integer, Account> intToAccountWithCompose = entier->personToAccount.compose(intToPerson).apply(entier);
    ...
    private Function<Integer, Account> intToAccountWithAndThen = entier->intToPerson.andThen(personToAccount).apply(entier);
